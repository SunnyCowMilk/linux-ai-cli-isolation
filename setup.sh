...
# --- Generate unified shell entry point ---
AI_CLI_ENV="$HOME/.ai_cli_env"
echo -e "🔧 Generating ${GREEN}$AI_CLI_ENV${NC}..."
cat << 'HEADER' > "$AI_CLI_ENV"
# AI CLI Configuration (auto-generated by setup.sh)
...
add_to_shell_profile "$AI_CLI_ENV" && NEED_RELOAD_SHELL=true
...
#!/bin/bash
unset ANTHROPIC_BASE_URL ANTHROPIC_API_KEY ANTHROPIC_MODEL ANTHROPIC_SMALL_FAST_MODEL
